...
(function () {
  ...
  var logoUrl =
    "https://harpn.s3.eu-west-2.amazonaws.com/cavmag/cavmag35/cavmag_logo_edition35.jpg";
  var logoUrlInner =
    "https://harpn.s3.eu-west-2.amazonaws.com/cavmag/cavmag35/cavmag_wide_edition35.png";
      ...
      if (node.tagName === "A") {
        ...
        if (!isCurrent) {
          ...
          const clean = pathname
            .replace("/cavmag-35" /* giles dont forget this */, "")
            .replace("/index.html", "");
